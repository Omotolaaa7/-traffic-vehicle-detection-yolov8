...
des conditions identiques. La \cref{sec-dynamique} permet de préciser
cette limite plutôt que de seulement la constater : les pertes de
validation étant encore à leur minimum à la dernière epoch, la borne des
50 epochs a effectivement été atteinte avant la convergence. Nos chiffres
absolus sont donc un plancher, et prolonger l'entraînement est la
première expérience à mener — avant même de passer à une déclinaison de
modèle plus grande ou au jeu de données complet.
