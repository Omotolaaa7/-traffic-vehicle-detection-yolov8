...
\begin{figure}[tb]
  \centering
  % \includegraphics[width=0.9\linewidth]{figures/courbes_entrainement.pdf}
  \fbox{\parbox[c][5cm][c]{0.85\linewidth}{\centering
    \todo{exporter depuis le dossier \texttt{runs/} de Colab le
    \texttt{results.png} de l'entraînement (ou le retracer en PDF
    vectoriel avec matplotlib) et le déposer sous
    \texttt{figures/courbes\_entrainement.pdf}}}}
  ...
  validation, au fil des 50 epochs.}
  \label{fig-courbes}
\end{figure}
